...
* [`SmileGeneratorFeatureDecorator`](src/main/java/net/logstash/logback/decorate/smile/SmileGeneratorFeatureDecorator.java)
* [`CborGeneratorFeatureDecorator`](src/main/java/net/logstash/logback/decorate/cbor/CborGeneratorFeatureDecorator.java)
* [`YamlGeneratorFeatureDecorator`](src/main/java/net/logstash/logback/decorate/yaml/YamlGeneratorFeatureDecorator.java)
...
[PrettyPrintingMapperBuilderDecorator](/src/main/java/net/logstash/logback/decorate/PrettyPrintingMapperBuilderDecorator.java)
...
You can also disable all the default escape sequences by specifying `<includeStandardAsciiEscapesForJSON>false</includeStandardAsciiEscapesForJSON>` on the `CharacterEscapesJsonFactoryBuilderDecorator`.
