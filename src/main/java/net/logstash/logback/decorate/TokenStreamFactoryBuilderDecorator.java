...
import com.fasterxml.jackson.core.TokenStreamFactory.TSFBuilder;
 ...
 */
public interface TokenStreamFactoryBuilderDecorator<F extends TokenStreamFactory, B extends TokenStreamFactory.TSFBuilder<F, B>>
        extends Decorator<B> {
}
